    ...
    implements Serializable, Person
{
    ...
    @XmlElement(name = "maiden-name")
    protected String maidenName;
    @XmlElement(name = "phonetic-first-name")
    protected String phoneticFirstName;
    @XmlElement(name = "phonetic-last-name")
    protected String phoneticLastName;
    @XmlElement(name = "formatted-phonetic-name")
    protected String formattedPhoneticName;
    @XmlElement(name = "mfeed-rss-url")
    protected String mfeedRssUrl;
    @XmlElement(type = CoursesImpl.class)
    protected CoursesImpl courses;
    @XmlElement(type = ProjectsImpl.class)
    protected ProjectsImpl projects;
    protected VolunteerImpl volunteer;
    @XmlElement(name = "email-address")
    protected String emailAddress;
    @XmlElement(name = "primary-twitter-account", type = PrimaryTwitterAccountImpl.class)
    protected PrimaryTwitterAccountImpl primaryTwitterAccount;
    @XmlElement(name = "bound-account-types")
    protected BoundAccountTypesImpl boundAccountTypes;
    @XmlElement(name = "last-modified-timestamp")
    protected String lastModifiedTimestamp;
    protected FollowingImpl following;
    protected SuggestionsImpl suggestions;
    @XmlElement(name = "formatted-name")
    ...
    @XmlElement(name = "honors-awards", type = HonorsAwardsImpl.class)
    ...
    @XmlElement(name = "group-memberships", type = MemberGroupsImpl.class)
    ...
    @XmlElement(name = "related-profile-views")
	...
	public BoundAccountTypes getBoundAccountTypes() {
