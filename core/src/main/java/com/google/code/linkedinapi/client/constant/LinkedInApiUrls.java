...
public final class LinkedInApiUrls {
    ...
    public static final String GET_COMPANY_UPDATE =
            linkedInApiUrls.getProperty("com.google.code.linkedinapi.client.getCompanyUpdate");    
    ...
    public static final String GET_GROUP_MEMBERSHIP_ROLE =
        linkedInApiUrls.getProperty("com.google.code.linkedinapi.client.getGroupMembershipRole");
