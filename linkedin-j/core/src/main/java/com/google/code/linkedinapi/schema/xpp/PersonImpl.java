    ...
    implements Person
{
    ...
    protected HonorsAwardsImpl honorsAwards;
    ...
    protected String formattedPhoneticName;
    protected String mfeedRssUrl;
    protected CoursesImpl courses;
    protected ProjectsImpl projects;
    protected VolunteerImpl volunteer;
    protected String emailAddress;
    protected PrimaryTwitterAccountImpl primaryTwitterAccount;
    protected BoundAccountTypesImpl boundAccountTypes;
    protected String lastModifiedTimestamp;
    protected FollowingImpl following;
    protected Suggestions suggestions;
    protected RelatedProfileViewsImpl relatedProfileViews;
    ...
    public void setHonorsAwards(HonorsAwards value) {
        this.honorsAwards = ((HonorsAwardsImpl) value);
    }
	...
	public void setFormattedPhoneticName(String value) {
		this.formattedPhoneticName = value;
	}
	...
	public void setMfeedRssUrl(String value) {
		this.mfeedRssUrl = value;
	}
	...
	public void setCourses(Courses value) {
		this.courses = ((CoursesImpl) value);
	}
	...
	public void setVolunteers(Volunteer value) {
		this.volunteer = ((VolunteerImpl) value);
	}
	...
	public void setProjects(Projects value) {
		this.projects = ((ProjectsImpl) value);
	}
	...
	public PrimaryTwitterAccount getPrimaryTwitterAccount() {
		return primaryTwitterAccount;
	}

	public void setPrimaryTwitterAccount(PrimaryTwitterAccount value) {
		this.primaryTwitterAccount = ((PrimaryTwitterAccountImpl) value);
	}

	public BoundAccountTypesImpl getBoundAccountTypes() {
		return boundAccountTypes;
	}

	public void setBoundAccountTypes(BoundAccountTypes value) {
		this.boundAccountTypes = ((BoundAccountTypesImpl) value);
	}
	...
	public void setFollowing(Following value) {
		this.following = ((FollowingImpl) value);
	}
	...
	public void setSuggestions(Suggestions value) {
		this.suggestions = ((SuggestionsImpl) value);
	}
	
	public RelatedProfileViews getRelatedProfileViews() {
		return relatedProfileViews;
	}

	public void setRelatedProfileViews(RelatedProfileViews value) {
		this.relatedProfileViews = ((RelatedProfileViewsImpl) value);
	...
	public void init(XmlPullParser parser) throws IOException, XmlPullParserException {
        ...
        while (parser.nextTag() == XmlPullParser.START_TAG) {
        	...
        	} else if (name.equals("maiden-name")) {
        		setMaidenName(XppUtils.getElementValueFromNode(parser));
        	} else if (name.equals("formatted-name")) {
        		setFormattedName(XppUtils.getElementValueFromNode(parser));
        	} else if (name.equals("phonetic-first-name")) {
        		setPhoneticFirstName(XppUtils.getElementValueFromNode(parser));
        	} else if (name.equals("phonetic-last-name")) {
        		setPhoneticLastName(XppUtils.getElementValueFromNode(parser));
        	} else if (name.equals("formatted-phonetic-name")) {
        		setFormattedName(XppUtils.getElementValueFromNode(parser));
        	} else if (name.equals("mfeed-rss-url")) {
        		setMfeedRssUrl(XppUtils.getElementValueFromNode(parser));
        	} else if (name.equals("courses")) {
        		CoursesImpl course = new CoursesImpl();
        		course.init(parser);
    			setCourses(course);
        	} else if (name.equals("volunteer")) {
        		VolunteerImpl vol = new VolunteerImpl();
        		vol.init(parser);
        		setVolunteers(vol);
        	} else if (name.equals("projects")) {
        		ProjectsImpl proj = new ProjectsImpl();
        		proj.init(parser);
    			setProjects(proj);
        	} else if (name.equals("email-address")) {
        		setEmailAddress(XppUtils.getElementValueFromNode(parser));
        	} else if (name.equals("related-profile-views")) {
        		RelatedProfileViewsImpl relProView = new RelatedProfileViewsImpl();
        		relProView.init(parser);
    			setRelatedProfileViews(relProView);
        	} else if (name.equals("primary-twitter-account")) {
    			PrimaryTwitterAccountImpl twitterAccount = new PrimaryTwitterAccountImpl();
    			twitterAccount.init(parser);
    			setPrimaryTwitterAccount(twitterAccount);
        	} else if (name.equals("bound-account-types")) {
        		BoundAccountTypesImpl boundAccount = new BoundAccountTypesImpl();
        		boundAccount.init(parser);
    			setBoundAccountTypes(boundAccount);
        	} else if (name.equals("last-modified-timestamp")) {
        		setLastModifiedTimestamp(XppUtils.getElementValueFromNode(parser));
        	} else if (name.equals("email-address")) {
        		setEmailAddress(XppUtils.getElementValueFromNode(parser));
        	} else if (name.equals("following")) {
        		FollowingImpl follow = new FollowingImpl();
        		follow.init(parser);
    			setFollowing(follow);
        	} else if (name.equals("suggestions")) {
        		SuggestionsImpl sugg = new SuggestionsImpl();
        		sugg.init(parser);
    			setSuggestions(sugg);
        	...
        	} else if (name.equals("proposal-comments")) {
        		setAssociations(XppUtils.getElementValueFromNode(parser));
        	} else if (name.equals("honors-awards")) {
        		HonorsAwardsImpl honors = new HonorsAwardsImpl();
        		honors.init(parser);
    			setHonorsAwards(honors);
	...
	public void toXml(XmlSerializer serializer) throws IOException {
		...
		XppUtils.setElementValueToNode(element, "maiden-name", getMaidenName());
		XppUtils.setElementValueToNode(element, "formatted-name", getFormattedName());
		...
		XppUtils.setElementValueToNode(element, "proposal-comments", getProposalComments());
		XppUtils.setElementValueToNode(element, "specialties", getSpecialties());
		XppUtils.setElementValueToNode(element, "phonetic-first-name", getPhoneticFirstName());
		XppUtils.setElementValueToNode(element, "phonetic-last-name", getPhoneticLastName());
		XppUtils.setElementValueToNode(element, "formatted-phonetic-name", getFormattedPhoneticName());
		XppUtils.setElementValueToNode(element, "mfeed-rss-url", getMfeedRssUrl());
		XppUtils.setElementValueToNode(element, "email-address", getEmailAddress());
		XppUtils.setElementValueToNode(element, "last-modified-timestamp", getLastModifiedTimestamp());
		...
		if (getProjects() != null) {
			((ProjectsImpl) getProjects()).toXml(serializer);
		}
		if (getCourses() != null) {
			((CoursesImpl) getCourses()).toXml(serializer);
		}
		if (getHonorsAwards() != null){
			((HonorsAwardsImpl) getHonorsAwards()).toXml(serializer);
		}
		if (getRelatedProfileViews() != null){
			((RelatedProfileViewsImpl) getRelatedProfileViews()).toXml(serializer);
		}
		if (getBoundAccountTypes() != null){
			((BoundAccountTypesImpl) getBoundAccountTypes()).toXml(serializer);
		}
		if (getPatents() != null) {
		...
		if (getVolunteers() != null) {
			((VolunteerImpl) getVolunteers()).toXml(serializer);
		}
		if (getFollowing() != null) {
			((FollowingImpl) getFollowing()).toXml(serializer);
		}
		if (getSuggestions() != null) {
			((SuggestionsImpl) getSuggestions()).toXml(serializer);
		}
		if (getSkills() != null) {
		...
		if (getPrimaryTwitterAccount() != null) {
			((PrimaryTwitterAccountImpl) getPrimaryTwitterAccount()).toXml(serializer);
		}
